...
optimized: CFLAGS += -O2 -funswitch-loops -fpredictive-commoning -ftree-loop-vectorize -floop-interchange -floop-unroll-and-jam -fvect-cost-model -ftree-partial-pre -fpeel-loops -fipa-cp-clone -fomit-frame-pointer -ffast-math
optimized: clean

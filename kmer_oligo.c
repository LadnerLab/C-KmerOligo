...
{
    FILE* temp = tmpfile();
    char* blosum90_data  =   "A  R  N  D  C  Q  E  G  H  I  L  K  M  F  P  S  T  W  Y  V  B  J  Z  X  *   \n\0" 
...
{
    FILE* temp = tmpfile();
    char* blosum62_data  = "   A  R  N  D  C  Q  E  G  H  I  L  K  M  F  P  S  T  W  Y  V  B  Z  X  *  \n"
